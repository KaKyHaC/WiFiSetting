...
//                    fragment.addRandomPeer();
            ...
            case R.id.atn_direct_discover:
                ...
                manager.discoverPeers(channel, new ActionListener() {
                    ...
                    public void onSuccess() {
                        Toast.makeText(WiFiDirectActivity.this, "Поиск",
                                Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(int reasonCode) {
                        Toast.makeText(WiFiDirectActivity.this, "Поиск провален : " + reasonCode,
                                Toast.LENGTH_SHORT).show();
                    }
                });
                return true;
    ...
    public void connect(WifiP2pConfig config) {
        manager.connect(channel, config, new ActionListener() {
            ...
            public void onFailure(int reason) {
                Toast.makeText(WiFiDirectActivity.this, "Подключение провалено.Повторите",
                        Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onChannelDisconnected() {
        ...
        if (manager != null && !retryChannel) {
            Toast.makeText(this, "Канал потерян.Попробуйте позже", Toast.LENGTH_LONG).show();
            resetData();
            retryChannel = true;
        ...
        if (manager != null) {
            ...
            if (fragment.getDevice() == null
                ...
                manager.cancelConnect(channel, new ActionListener() {
                    ...
                    @Override
                    public void onSuccess() {
                        Toast.makeText(WiFiDirectActivity.this, "Подключение прервано",
                                Toast.LENGTH_SHORT).show();
                    }
